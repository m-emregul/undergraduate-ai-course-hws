...
def monte_carlo_tree(current_board, number):
    ...
    for i in range(number):
        ...
        result = 1
        while True:
                                # oyun bitene kadar rastgele hamlelerle simüle edilir. Bilgisayar kazanırsa 2, berabere biterse 1, kullanıcı kazanırsa 0 sonucu çıkarılır.
